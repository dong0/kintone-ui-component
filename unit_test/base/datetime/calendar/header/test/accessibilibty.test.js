...
describe("BaseDateTimeCalendarHeader", () => {
    describe("accessibility", () => {
        it("should be 2022 when mousedown on the item 2022", async () => {
            ...
            const yearSelectEl = el.querySelector(".kuc-base-datetime-header-year__toggle__label");
            btnYearToggleEl.click();
            await elementUpdated(container);
            const itemsEl = el.querySelectorAll(".kuc-base-datetime-listbox__listbox")[0];
        ...
        it("should open listbox when focus button toggle and press key ArrowDown", async () => {
            const container = document.createElement("kuc-base-datetime-calendar-header");
            const el = await fixture(container);
            const btnMonthToggleEl = el.querySelector(".kuc-base-datetime-header-year__toggle");
            btnMonthToggleEl.focus();
            btnMonthToggleEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowDown", bubbles: true }));
            await elementUpdated(container);
            const itemsEl = el.querySelectorAll(".kuc-base-datetime-listbox__listbox")[0];
        ...
        it("should be FEBRUARY when press key Enter FEBRUARY in dropdown", async () => {
            const container = document.createElement("kuc-base-datetime-calendar-header");
            const el = await fixture(container);
            const monthSelectEl = el.querySelector(".kuc-base-datetime-header-month__toggle__label");
        ...
        it("should open month dropdown when press key Enter on button month toggle", async () => {
            ...
            const btnMonthToggleEl = el.querySelector(".kuc-base-datetime-header-month__toggle");
            btnMonthToggleEl.focus();
            btnMonthToggleEl.dispatchEvent(new KeyboardEvent("keydown", { key: "Enter" }));
            await elementUpdated(container);
            const listBoxElHide = el.querySelector(".kuc-base-datetime-header-month__listbox");
        ...
        it("should open year dropdown when press key Enter on button year toggle", async () => {
            ...
            btnYearToggleEl.dispatchEvent(new KeyboardEvent("keydown", { key: "Enter" }));
            await elementUpdated(container);
            const listBoxElHide = el.querySelector(".kuc-base-datetime-header-year__listbox");
            expect(listBoxElHide.getAttribute("aria-hidden")).to.equal("false");
        });
        ...
        it("should do nothing when pressing Tab key on button month toggle", async () => {
            ...
            const btnMonthToggleEl = el.querySelector(".kuc-base-datetime-header-month__toggle");
            btnMonthToggleEl.focus();
            btnMonthToggleEl.dispatchEvent(new KeyboardEvent("keydown", { key: "Tab" }));
            await elementUpdated(container);
        ...
        it("should do nothing when pressing Tab key on button year toggle", async () => {
            ...
            const btnYearToggleEl = el.querySelector(".kuc-base-datetime-header-year__toggle");
            btnYearToggleEl.focus();
            btnYearToggleEl.dispatchEvent(new KeyboardEvent("keydown", { key: "Tab" }));
            await elementUpdated(container);
        ...
        it("should do nothing when pressing not handled key on button month toggle", async () => {
            ...
            const btnMonthToggleEl = el.querySelector(".kuc-base-datetime-header-month__toggle");
            btnMonthToggleEl.focus();
            btnMonthToggleEl.dispatchEvent(new KeyboardEvent("keydown", { key: "a" }));
            await elementUpdated(container);
            expect(btnMonthToggleEl.getAttribute("aria-expanded")).to.equal("false");
        });
