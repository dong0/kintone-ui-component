...
describe("BaseDateTimeCalendarHeader", () => {
    describe("year", () => {
        it("should be 2021 when not assigning", async () => {
            ...
            const optionMonthEl = el.querySelector(".kuc-base-datetime-header-year__listbox");
        ...
        it("should open/close dropdown year when click button year toggle", async () => {
            ...
            btnYearToggleEl.click();
            await elementUpdated(container);
            const listBoxElShow = el.querySelector(".kuc-base-datetime-header-year__listbox");
        ...
        it("should close year dropdown when press key Escape on year dropdown", async () => {
            ...
            liEl.dispatchEvent(new KeyboardEvent("keydown", { key: "Escape", bubbles: true }));
            await elementUpdated(container);
            const listBoxElHide = el.querySelector(".kuc-base-datetime-header-year__listbox");
            expect(listBoxElHide).to.equal(null);
        });
