...
describe("BaseDateTimeCalendar", () => {
    describe("kuc:calendar-header-change event", () => {
        it("should be triggered kuc:calendar-header-change event", async () => {
            ...
            const buttonEl = el.querySelector("kuc-base-datetime-calendar-header .kuc-base-datetime-calendar-header__group__button--next-month");
            buttonEl.click();
        ...
        it("should be triggered kuc:calendar-body-change-date event", async () => {
            ...
            const el = await fixture(container);
            const selectedEl = el.querySelector('kuc-base-datetime-calendar-body .kuc-base-datetime-calendar-body__table__date__button[aria-current="true"]');
