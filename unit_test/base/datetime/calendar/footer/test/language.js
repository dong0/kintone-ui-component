...
describe("BaseDateTimeCalendarFooter", () => {
    describe("language", () => {
        it("should be 'en' when not assigning language prop", async () => {
            ...
            const buttonTodayEl = el.querySelector(".kuc-base-datetime-calendar-footer__group__button--today");
            const buttonNoneEl = el.querySelector(".kuc-base-datetime-calendar-footer__group__button--none");
