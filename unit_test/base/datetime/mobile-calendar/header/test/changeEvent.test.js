...
describe("BaseMobileDateTimeCalendarHeader", () => {
    describe("kuc:mobile-calendar-header-change event", () => {
        it("should be triggered when click the previous month button", async () => {
            ...
            const buttonEl = el.querySelector(".kuc-base-mobile-datetime-calendar-header__group__button--previous-month");
            buttonEl.click();
        ...
        it("should be triggered when click the next month button", async () => {
            ...
            const el = await fixture(container);
            const buttonEl = el.querySelector(".kuc-base-mobile-datetime-calendar-header__group__button--next-month");
            buttonEl.click();
            expect(triggeredEvent.type).to.equal("kuc:mobile-calendar-header-change");
        ...
        it("should be triggered when change a year", async () => {
            ...
            const el = await fixture(container);
            const selectYearEl = el.querySelector(".kuc-base-mobile-datetime-calendar-header__group__center__year__select");
        ...
        it("should be triggered when change a month", async () => {
            ...
            const el = await fixture(container);
            const selectMonthEl = el.querySelector(".kuc-base-mobile-datetime-calendar-header__group__center__month__select");
