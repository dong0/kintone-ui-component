...
describe("BaseMobileDateTimeCalendarFooter", () => {
    describe("click event", () => {
        it("should be triggered kuc:calendar-footer-click-none event", async () => {
            ...
            const buttonEl = el.querySelector(".kuc-base-mobile-datetime-calendar-footer__group__button--none");
            buttonEl.click();
        ...
        it("should be triggered kuc:calendar-footer-click-today event", async () => {
            ...
            const el = await fixture(container);
            const buttonEl = el.querySelector(".kuc-base-mobile-datetime-calendar-footer__group__button--today");
            buttonEl.click();
            await elementUpdated(buttonEl);
        ...
        it("should be triggered kuc:calendar-footer-click-close event", async () => {
            ...
            const el = await fixture(container);
            const buttonEl = el.querySelector(".kuc-base-mobile-datetime-calendar-footer__group__button--close");
            buttonEl.click();
            await elementUpdated(buttonEl);
