...
describe("BaseMobileDateTimeCalendarBody", () => {
    describe("kuc:mobile-calendar-body-click-date event", () => {
        it("should be triggered kuc:mobile-calendar-body-click-date event", async () => {
            ...
            const container = document.createElement("kuc-base-mobile-datetime-calendar-body");
            ...
            container.addEventListener("kuc:mobile-calendar-body-click-date", (event) => {
                triggeredEvent = event;
            });
            const el = await fixture(container);
            const itemsEl = el.querySelectorAll(".kuc-base-mobile-datetime-calendar-body__table__date");
            itemsEl[ItemForTest.index].click();
            expect(triggeredEvent.type).to.equal("kuc:mobile-calendar-body-click-date");
