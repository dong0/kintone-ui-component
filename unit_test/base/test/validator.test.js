...
import { validateProps, validateTimeValue, validateTimeStepNumber, validateTimeStep, validateItems, validateValueArray, validateValueString, validateSelectedIndexArray, validateSelectedIndexNumber, validateDateTimeValue, } from "../validator";
describe("Base", () => {
    describe("Validator", () => {
