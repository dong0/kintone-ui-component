...
describe("Dropdown", () => {
    describe("accessibility", () => {
        it("should show/hide menu element when clicking toggle button", async () => {
            ...
            let menuEl = el.querySelector(".kuc-dropdown__group__select-menu");
            expect(menuEl).not.has.attribute("hidden");
            toggle.click();
            await elementUpdated(container);
            menuEl = el.querySelector(".kuc-dropdown__group__select-menu");
        ...
        it("should be highlight/not highlight when mouseover/mouseleave the item", async () => {
            ...
            expect(itemsEl[2].classList.contains("kuc-dropdown__group__select-menu__highlight")).to.equal(true);
            const menuEl = el.querySelector(".kuc-dropdown__group__select-menu");
            menuEl.dispatchEvent(new Event("mouseleave"));
            expect(itemsEl[0].classList.contains("kuc-dropdown__group__select-menu__highlight")).to.equal(false);
            expect(itemsEl[1].classList.contains("kuc-dropdown__group__select-menu__highlight")).to.equal(false);
            expect(itemsEl[2].classList.contains("kuc-dropdown__group__select-menu__highlight")).to.equal(false);
        });
        ...
        it('should be highlight next item when triggered "ArrowDown" keyboard event', async () => {
            ...
            toggleEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowDown" }));
            const itemsEl = el.querySelectorAll(".kuc-dropdown__group__select-menu__item");
            expect(itemsEl[1].classList.contains("kuc-dropdown__group__select-menu__highlight")).to.equal(true);
        });
        ...
        it('should highlight first item when pressing "Home" key', async () => {
            ...
            await elementUpdated(el);
            const itemsEl = el.querySelectorAll(".kuc-dropdown__group__select-menu__item");
            expect(itemsEl[0].classList.contains("kuc-dropdown__group__select-menu__highlight")).to.equal(true);
        });
