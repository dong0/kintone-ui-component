...
describe("TimePicker", () => {
    describe("accessibility-minute", () => {
        it("should focus hour input when press ArrowLeft on minute input", async () => {
            ...
            inputHourEl.addEventListener("focus", (event) => {
                triggeredEvent = event;
            });
            inputMinuteEl.focus();
            await elementUpdated(el);
            inputMinuteEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowLeft", bubbles: true }));
            await elementUpdated(el);
        ...
        it('should be "13:00" when focused input minute and press Delete key', async () => {
            ...
            inputHourEl.click();
            inputMinuteEl.click();
            inputMinuteEl.dispatchEvent(new KeyboardEvent("keydown", { key: "Backspace", bubbles: true }));
            await elementUpdated(el);
        ...
        it("should be increase 1 minute when focused input minute and press ArrowUp key", async () => {
            ...
            const inputMinuteEl = el.querySelector(".kuc-base-time__group__minutes");
            inputMinuteEl.click();
            inputMinuteEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowUp", bubbles: true }));
            await elementUpdated(el);
            expect(inputHourEl.value).to.be.equal("13");
        ...
        it("should be decrease 1 minute when focused input minute and press ArrowDown key", async () => {
            ...
            const inputMinuteEl = el.querySelector(".kuc-base-time__group__minutes");
            inputMinuteEl.click();
            inputMinuteEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowDown", bubbles: true }));
            await elementUpdated(el);
        ...
        it("should change minute when press number key on minute input", async () => {
            ...
            const inputMinuteEl = el.querySelector(".kuc-base-time__group__minutes");
            inputMinuteEl.focus();
            inputMinuteEl.dispatchEvent(new KeyboardEvent("keydown", { key: "2", bubbles: true }));
            await elementUpdated(el);
            expect(inputHourEl.value).to.be.equal("13");
            expect(inputMinuteEl.value).to.be.equal("52");
            inputMinuteEl.dispatchEvent(new KeyboardEvent("keydown", { key: "8", bubbles: true }));
            await elementUpdated(el);
            expect(inputHourEl.value).to.be.equal("13");
