...
describe("TimePicker", () => {
    describe("accessibility-hour", () => {
        it("should focus minute input when press ArrowRight on hour input", async () => {
            let triggeredEventMinute = null;
            let triggeredEventSuffix = null;
            ...
            const inputSuffixEl = el.querySelector(".kuc-base-time__group__suffix");
            inputMinuteEl.addEventListener("focus", (event) => {
                triggeredEventMinute = event;
            });
            inputSuffixEl.addEventListener("focus", (event) => {
                triggeredEventSuffix = event;
            });
            inputHourEl.focus();
            await elementUpdated(el);
            inputHourEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowRight", bubbles: true }));
            await elementUpdated(el);
            expect(triggeredEventMinute.type).to.equal("focus");
            inputHourEl.dispatchEvent(new KeyboardEvent("keydown", { key: "Enter", bubbles: true }));
            await elementUpdated(el);
        ...
        it('should be "00" when focused input hour/minute and press Delete/BackSpace key', async () => {
            ...
            const inputMinuteEl = el.querySelector(".kuc-base-time__group__minutes");
            inputHourEl.click();
            inputHourEl.dispatchEvent(new KeyboardEvent("keydown", { key: "Delete", bubbles: true }));
            inputHourEl.dispatchEvent(new KeyboardEvent("keydown", { key: "Tab", bubbles: true }));
        ...
        it("should not change value when focused input hour and press unsupported key", async () => {
            ...
            const inputMinuteEl = el.querySelector(".kuc-base-time__group__minutes");
            inputHourEl.focus();
            inputHourEl.dispatchEvent(new KeyboardEvent("keydown", { key: "a", bubbles: true }));
            await elementUpdated(el);
        ...
        it("should be increase 1 hour when focused input hour and press ArrowUp key", async () => {
            ...
            const inputMinuteEl = el.querySelector(".kuc-base-time__group__minutes");
            inputHourEl.click();
            inputHourEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowUp", bubbles: true }));
            await elementUpdated(el);
        ...
        it("should be decrease 1 hour when focused input hour and press ArrowDown key", async () => {
            ...
            const inputMinuteEl = el.querySelector(".kuc-base-time__group__minutes");
            inputHourEl.click();
            inputHourEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowDown", bubbles: true }));
            await elementUpdated(el);
            expect(inputHourEl.value).to.be.equal("00");
            expect(inputMinuteEl.value).to.be.equal("15");
            inputHourEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowDown", bubbles: true }));
        ...
        it("should 08:00 when press 8 key on hour input", async () => {
            ...
            const inputMinuteEl = el.querySelector(".kuc-base-time__group__minutes");
            inputHourEl.focus();
            inputHourEl.dispatchEvent(new KeyboardEvent("keydown", { key: "8", bubbles: true }));
            await elementUpdated(el);
            expect(inputHourEl.value).to.be.equal("08");
            expect(inputMinuteEl.value).to.be.equal("15");
        });
