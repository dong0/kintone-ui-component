...
describe("MobileDateTimePicker", () => {
    describe("value", () => {
        it("should be empty string when not assigning", async () => {
            ...
            const inputHourEl = el.querySelector(".kuc-base-mobile-time__group__hours");
            const inputMinuteEl = el.querySelector(".kuc-base-mobile-time__group__minutes");
        ...
        it("should be today value when pressing today button on calendar", async () => {
            ...
            await elementUpdated(el);
            const todayBtnEl = el.querySelector(".kuc-base-mobile-datetime-calendar-footer__group__button--today");
            todayBtnEl.click();
            await elementUpdated(el);
        ...
        it("should be undefined when select empty on hour", async () => {
            ...
            await elementUpdated(el);
            const inputHourEl = el.querySelector(".kuc-base-mobile-time__group__hours");
            const baseTimeEl = el.querySelector(".kuc-mobile-datetime-picker__group__input--time");
            inputHourEl.value = "";
            baseTimeEl.dispatchEvent(new CustomEvent("kuc:base-mobile-time-change", {
                detail: {
                    value: ":00",
                    oldValue: "00:00",
