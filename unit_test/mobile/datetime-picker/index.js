...
(() => {
    exportMobileDateTimePicker = window.customElements.get("kuc-mobile-datetime-picker");
    ...
    window.customElements.define("kuc-mobile-datetime-picker", KucMobileDateTimePicker);
