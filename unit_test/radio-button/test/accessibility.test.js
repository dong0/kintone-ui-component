...
describe("RadioButton", () => {
    describe("accessibility", () => {
        it("can be focused and blured", async () => {
            ...
            expect(document.activeElement?.classList.contains("kuc-radio-button__group__select-menu__item__input")).to.equal(true);
            await triggerBlurFor(itemsEl);
            expect(document.activeElement?.classList.contains("kuc-radio-button__group__select-menu__item__input")).to.equal(false);
        });
    });
});
