...
describe("MobileRadioButton", () => {
    describe("items", () => {
        ...
        it("should set label the same as value when not assigned items label on constructor", async () => {
            ...
            const labelEl0 = itemsEl[0].querySelector("label");
            ...
            const labelEl1 = itemsEl[1].querySelector("label");
            ...
            const labelEl2 = itemsEl[2].querySelector("label");
        ...
        it("should be throw error when assigned dupplicated items on constructor", async () => {
            ...
            try {
                ...
                let errorMessage = "'items[1].value' is duplicated! You can specify unique one.";
                if (error instanceof Error) {
                    errorMessage = error.message;
                }
                expect(errorMessage).to.equal("'items[1].value' is duplicated! You can specify unique one.");
            }
            // TODO:
            // Implement checking if source code does not throw error in validateItems function
        });
