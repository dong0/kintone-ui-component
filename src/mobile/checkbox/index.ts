...
(() => {
  exportMobileCheckbox = window.customElements.get("kuc-mobile-checkbox");
  ...
  window.customElements.define("kuc-mobile-checkbox", KucMobileCheckbox);
  createStyleOnHeader(MOBILE_CHECKBOX_CSS);
  exportMobileCheckbox = KucMobileCheckbox;
})();
const MobileCheckbox = exportMobileCheckbox as any;
