...
export class BaseMobileDateTimeCalendarFooter extends KucBase {
    ...
    render() {
        return html `
      <div class="kuc-base-mobile-datetime-calendar-footer-1-3-2__group">
        <button
          type="button"
          class="kuc-base-mobile-datetime-calendar-footer-1-3-2__group__button kuc-base-mobile-datetime-calendar-footer-1-3-2__group__button--today"
        ...
        <button
          type="button"
          class="kuc-base-mobile-datetime-calendar-footer-1-3-2__group__button kuc-base-mobile-datetime-calendar-footer-1-3-2__group__button--none"
        ...
        <button
          type="button"
          class="kuc-base-mobile-datetime-calendar-footer-1-3-2__group__button kuc-base-mobile-datetime-calendar-footer-1-3-2__group__button--close"
...
if (!window.customElements.get("kuc-base-mobile-datetime-calendar-footer-1-3-2")) {
    createStyleOnHeader(BASE_MOBILE_CALENDAR_FOOTER_CSS);
    window.customElements.define("kuc-base-mobile-datetime-calendar-footer-1-3-2", BaseMobileDateTimeCalendarFooter);
}
