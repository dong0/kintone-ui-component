...
export class BaseMobileDateTimeCalendarHeader extends KucBase {
    ...
    render() {
        return html `
      <div class="kuc-base-mobile-datetime-calendar-header-1-3-2__group">
        <button
          aria-label="previous month"
          type="button"
          class="kuc-base-mobile-datetime-calendar-header-1-3-2__group__button kuc-base-mobile-datetime-calendar-header-1-3-2__group__button--previous-month"
          @click="${this._handleClickCalendarPrevMonthBtn}"
        >
          ${this._getLeftArrowIconSvgTemplate()}
        </button>
        <div class="kuc-base-mobile-datetime-calendar-header-1-3-2__group__center">
          ${this._getYearMonthTemplate()}
        </div>
        <button
          aria-label="next month"
          type="button"
          class="kuc-base-mobile-datetime-calendar-header-1-3-2__group__button kuc-base-mobile-datetime-calendar-header-1-3-2__group__button--next-month"
    ...
    _getMonthTemplate() {
        return html `
      <div
        class="kuc-base-mobile-datetime-calendar-header-1-3-2__group__center__month"
      >
        <select
          class="kuc-base-mobile-datetime-calendar-header-1-3-2__group__center__month__select"
    ...
    _getYearTemplate() {
        return html `
      <div
        class="kuc-base-mobile-datetime-calendar-header-1-3-2__group__center__year"
      >
        <select
          class="kuc-base-mobile-datetime-calendar-header-1-3-2__group__center__year__select"
...
__decorate([
    query(".kuc-base-mobile-datetime-calendar-header-1-3-2__group__center__month__select")
], BaseMobileDateTimeCalendarHeader.prototype, "_selectMonthEl", void 0);
__decorate([
    query(".kuc-base-mobile-datetime-calendar-header-1-3-2__group__center__year__select")
], BaseMobileDateTimeCalendarHeader.prototype, "_selectYearEl", void 0);
if (!window.customElements.get("kuc-base-mobile-datetime-calendar-header-1-3-2")) {
    createStyleOnHeader(BASE_MOBILE_CALENDAR_HEADER_CSS);
    window.customElements.define("kuc-base-mobile-datetime-calendar-header-1-3-2", BaseMobileDateTimeCalendarHeader);
}
