...
export class BaseMobileDateTimeCalendar extends KucBase {
    ...
    render() {
        return html `
      <div
        class="kuc-base-mobile-datetime-calendar-1-3-2__group"
        role="dialog"
        aria-modal="true"
        aria-label="Calender"
      ...
      >
        ...
        <kuc-base-mobile-datetime-calendar-body-1-3-2
          ...
          .language="${this.language}"
        ></kuc-base-mobile-datetime-calendar-body-1-3-2>
        <kuc-base-mobile-datetime-calendar-footer-1-3-2
          .language="${this.language}"
        ></kuc-base-mobile-datetime-calendar-footer-1-3-2>
      </div>
    `;
...
if (!window.customElements.get("kuc-base-mobile-datetime-calendar-1-3-2")) {
    createStyleOnHeader(BASE_MOBILE_CALENDAR);
    window.customElements.define("kuc-base-mobile-datetime-calendar-1-3-2", BaseMobileDateTimeCalendar);
}
