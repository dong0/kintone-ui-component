...
export class BaseTime extends KucBase {
    ...
    render() {
        return html `
      <div class="kuc-base-time-1-3-2__group" @click="${this._handleClickInputGroup}">
        <input
          type="text"
          class="kuc-base-time-1-3-2__group__hours"
          role="spinbutton"
        ...
        <input
          type="text"
          class="kuc-base-time-1-3-2__group__minutes"
          role="spinbutton"
      ...
      <button
        ...
        class="kuc-base-time-1-3-2__assistive-text"
    ...
    _toggleDisabledGroup() {
        if (this.disabled)
            return this._inputGroupEl.classList.add("kuc-base-time-1-3-2__group--disabled");
        return this._inputGroupEl.classList.remove("kuc-base-time-1-3-2__group--disabled");
    }
    _updateInputValue() {
        var _a;
    ...
    _handleBlurButton() {
        this._inputGroupEl.classList.remove("kuc-base-time-1-3-2__group--focus");
    }
    _handleFocusButton(event) {
        event.stopPropagation();
        this._inputGroupEl.classList.add("kuc-base-time-1-3-2__group--focus");
    }
    _openListBoxByKey() {
        if (this._listBoxVisible)
            return false;
    ...
    _getColonTemplate() {
        return this._hours
            ? html ` <span class="kuc-base-time-1-3-2__group__colon">:</span> `
            : "";
    }
    _getSuffixTemplate() {
        return this.hour12
            ? html `
          <input
            class="kuc-base-time-1-3-2__group__suffix"
            role="spinbutton"
    ...
    _getListBoxTemplate() {
        return this._listBoxVisible
          ...
          <kuc-base-datetime-listbox-1-3-2
            ...
            class="kuc-base-time-1-3-2__group__listbox"
...
__decorate([
    query(".kuc-base-time-1-3-2__group__hours")
], BaseTime.prototype, "_hoursEl", void 0);
__decorate([
    query(".kuc-base-time-1-3-2__group__minutes")
], BaseTime.prototype, "_minutesEl", void 0);
__decorate([
    query(".kuc-base-time-1-3-2__group__suffix")
], BaseTime.prototype, "_suffixEl", void 0);
__decorate([
    query(".kuc-base-time-1-3-2__assistive-text")
], BaseTime.prototype, "_toggleEl", void 0);
__decorate([
    query(".kuc-base-time-1-3-2__group")
], BaseTime.prototype, "_inputGroupEl", void 0);
if (!window.customElements.get("kuc-base-time-1-3-2")) {
    createStyleOnHeader(BASE_TIME_CSS);
    window.customElements.define("kuc-base-time-1-3-2", BaseTime);
}
