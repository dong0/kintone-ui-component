...
export class BaseDateTimeListBox extends KucBase {
    ...
    render() {
      ...
      <ul
        ...
        class="kuc-base-datetime-listbox-1-3-2__listbox"
        role="listbox"
    ...
    _setHighlightItemEl(itemEl) {
        ...
        itemEl.classList.add("kuc-base-datetime-listbox-1-3-2__listbox--highlight");
    ...
    _removeHighlight() {
        ...
        this._highlightItemEl.classList.remove("kuc-base-datetime-listbox-1-3-2__listbox--highlight");
    }
    ...
    _getListBoxItemTemplate(item) {
        ...
        return html `
      <li
        class="kuc-base-datetime-listbox-1-3-2__listbox__item"
        role="option"
    ...
    _getCheckedIconSvgTemplate() {
        return svg `<svg
          class="kuc-base-datetime-listbox-1-3-2__listbox__item__icon"
          width="11"
          height="9"
          viewBox="0 0 11 9"
          fill="none"
...
__decorate([
    query(".kuc-base-datetime-listbox-1-3-2__listbox")
], BaseDateTimeListBox.prototype, "_listBoxEl", void 0);
__decorate([
    queryAll(".kuc-base-datetime-listbox-1-3-2__listbox__item")
], BaseDateTimeListBox.prototype, "_itemsEl", void 0);
__decorate([
    query(".kuc-base-datetime-listbox-1-3-2__listbox__item")
], BaseDateTimeListBox.prototype, "_firstItemEl", void 0);
__decorate([
    query(".kuc-base-datetime-listbox-1-3-2__listbox__item:last-child")
], BaseDateTimeListBox.prototype, "_lastItemEl", void 0);
__decorate([
    query(".kuc-base-datetime-listbox-1-3-2__listbox--highlight")
], BaseDateTimeListBox.prototype, "_highlightItemEl", void 0);
__decorate([
    query(".kuc-base-datetime-listbox-1-3-2__listbox__item__icon")
...
if (!window.customElements.get("kuc-base-datetime-listbox-1-3-2")) {
    createStyleOnHeader(BASE_DATETIME_LISTBOX_CSS);
    window.customElements.define("kuc-base-datetime-listbox-1-3-2", BaseDateTimeListBox);
}
