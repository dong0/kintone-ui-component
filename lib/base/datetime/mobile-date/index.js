...
export class BaseMobileDate extends KucBase {
    ...
    render() {
        return html `
      <div class="kuc-mobile-base-date-1-3-2__group${this._getGroupClass()}">
        <input
          class="kuc-mobile-base-date-1-3-2__group__input"
          type="text"
          id="${this._GUID}-label"
          readonly="readonly"
        ...
        <button
          type="button"
          class="kuc-mobile-base-date-1-3-2__group__button"
          aria-label="calendar"
          @click="${this._handleClickOpenCalendar}"
          ?disabled="${this.disabled}"
        >
    ...
    _getGroupClass() {
        let groupClass = "";
        if (this.disabled) {
            groupClass += " kuc-mobile-base-date-1-3-2__group--disabled";
        }
        if (this.required) {
            groupClass += " kuc-mobile-base-date-1-3-2__group--required";
        }
        return groupClass;
    }
    ...
    _getCalendarTemplate() {
        return this._dateTimeCalendarVisible
            ? html `
          <kuc-base-mobile-datetime-calendar-1-3-2
            class="kuc-base-mobile-date-1-3-2__calendar"
...
__decorate([
    query(".kuc-mobile-base-date-1-3-2__group__button")
], BaseMobileDate.prototype, "_btnToggleEl", void 0);
__decorate([
    query(".kuc-mobile-base-date-1-3-2__group__input")
], BaseMobileDate.prototype, "_inputEl", void 0);
__decorate([
    query(".kuc-base-mobile-date-1-3-2__calendar")
], BaseMobileDate.prototype, "_calendarEl", void 0);
__decorate([
    state()
], BaseMobileDate.prototype, "_dateTimeCalendarVisible", void 0);
if (!window.customElements.get("kuc-mobile-base-date-1-3-2")) {
    createStyleOnHeader(BASE_MOBILE_DATE_CSS);
    window.customElements.define("kuc-mobile-base-date-1-3-2", BaseMobileDate);
}
