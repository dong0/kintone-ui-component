...
export class BaseDate extends KucBase {
    ...
    render() {
        return html `
      <input
        class="kuc-base-date-1-3-2__input"
        id="${this._GUID}-label"
        type="text"
        text-align="center"
      ...
      <button
        ...
        class="kuc-base-date-1-3-2__assistive-text"
      ...
      ${this._dateTimeCalendarVisible
            ? html `
            <kuc-base-datetime-calendar-1-3-2
              class="kuc-base-date-1-3-2__calendar"
    ...
    _handleBlurButton() {
        this._dateInput.classList.remove("kuc-base-date-1-3-2__input--focus");
    }
    _handleFocusButton() {
        this._dateInput.classList.add("kuc-base-date-1-3-2__input--focus");
    }
    _handleTabKey(event) {
        if (event.key === "Tab")
            return true;
...
__decorate([
    query(".kuc-base-date-1-3-2__assistive-text")
], BaseDate.prototype, "_toggleEl", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-header-1-3-2__group__button--previous-month")
], BaseDate.prototype, "_previousMonth", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-footer-1-3-2__group__button--none")
], BaseDate.prototype, "_footerNoneBtn", void 0);
__decorate([
    state()
], BaseDate.prototype, "_dateTimeCalendarVisible", void 0);
if (!window.customElements.get("kuc-base-date-1-3-2")) {
    createStyleOnHeader(BASE_DATE_CSS);
    window.customElements.define("kuc-base-date-1-3-2", BaseDate);
}
