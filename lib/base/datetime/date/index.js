...
export class BaseDate extends KucBase {
    ...
    _handleBlurButton() {
        this._dateInput.classList.remove("kuc-base-date-1-4-0__input--focus");
    }
    _handleFocusButton() {
        this._dateInput.classList.add("kuc-base-date-1-4-0__input--focus");
    }
    _handleTabKey(event) {
        if (event.key === "Tab")
            return true;
...
__decorate([
    query(".kuc-base-date-1-4-0__input")
], BaseDate.prototype, "_dateInput", void 0);
__decorate([
    query(".kuc-base-date-1-4-0__assistive-text")
], BaseDate.prototype, "_toggleEl", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-header-1-4-0__group__button--previous-month")
], BaseDate.prototype, "_previousMonth", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-footer-1-4-0__group__button--none")
], BaseDate.prototype, "_footerNoneBtn", void 0);
__decorate([
    state()
], BaseDate.prototype, "_dateTimeCalendarVisible", void 0);
if (!window.customElements.get("kuc-base-date-1-4-0")) {
    createStyleOnHeader(BASE_DATE_CSS);
    window.customElements.define("kuc-base-date-1-4-0", BaseDate);
}
