...
export class BaseMobileTime extends KucBase {
    ...
    render() {
        return html `
      <fieldset
        class="kuc-base-mobile-time-1-3-2__group${this.disabled
            ? " kuc-base-mobile-time-1-3-2__group--disabled"
            : ""}${this.required ? " kuc-base-mobile-time-1-3-2__group--required" : ""}"
        aria-label="label-text"
      >
        <select
          class="kuc-base-mobile-time-1-3-2__group__hours"
          aria-label="Hour"
        ...
        <span class="kuc-base-mobile-time-1-3-2__group__colon">:</span>
        <select
          class="kuc-base-mobile-time-1-3-2__group__minutes"
          aria-label="Minute"
          aria-describedby="${this.guid}-error"
          ?disabled="${this.disabled}"
...
__decorate([
    query(".kuc-base-mobile-time-1-3-2__group__hours")
], BaseMobileTime.prototype, "_hoursEl", void 0);
__decorate([
    query(".kuc-base-mobile-time-1-3-2__group__minutes")
], BaseMobileTime.prototype, "_minutesEl", void 0);
if (!window.customElements.get("kuc-base-mobile-time-1-3-2")) {
    createStyleOnHeader(BASE_MOBILE_TIME_CSS);
    window.customElements.define("kuc-base-mobile-time-1-3-2", BaseMobileTime);
}
