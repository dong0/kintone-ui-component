...
export class BaseDateTimeCalendarBody extends KucBase {
    ...
    _getDateClass(dateParts, isThisMonth) {
        if (isThisMonth) {
            ...
            if (isToday)
                return " kuc-base-datetime-calendar-body-1-4-0__table__date__button--today";
            return "";
        }
        const isToday = this._isToday(dateParts);
        if (isToday)
            return " kuc-base-datetime-calendar-body-1-4-0__table__date__button--today";
        return " kuc-base-datetime-calendar-body-1-4-0__table__date__button--other-month";
    }
            ...
            <tr>
              ${weeks.map((weekDate) => {
                ...
                return html `
                  <td
                    role="gridcell"
                    class="kuc-base-datetime-calendar-body-1-4-0__table__date${(this
                    .value === weekDate.attr ||
                    isSameDate) &&
                    isThisMonth
                    ? "--selected"
                  ...
                  >
                    ...
                    ? "0"
                    : "-1"}"
                      class="kuc-base-datetime-calendar-body-1-4-0__table__date__button${this._getDateClass(dateParts, isThisMonth)}"
...
__decorate([
    query('.kuc-base-datetime-calendar-body-1-4-0__table__date__button[aria-current="true"]')
], BaseDateTimeCalendarBody.prototype, "_selectedItem", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-body-1-4-0__table__date--selected")
], BaseDateTimeCalendarBody.prototype, "_highlightItem", void 0);
__decorate([
    query('.kuc-base-datetime-calendar-body-1-4-0__table__date__button[tabindex="0"]')
], BaseDateTimeCalendarBody.prototype, "_focusedItem", void 0);
if (!window.customElements.get("kuc-base-datetime-calendar-body-1-4-0")) {
    createStyleOnHeader(CALENDAR_BODY_CSS);
    window.customElements.define("kuc-base-datetime-calendar-body-1-4-0", BaseDateTimeCalendarBody);
}
