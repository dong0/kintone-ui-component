...
export class BaseDateTimeCalendarFooter extends KucBase {
    ...
    render() {
        return html `
      <div class="kuc-base-datetime-calendar-footer-1-3-2__group">
        <button
          type="button"
          tabindex="0"
          class="kuc-base-datetime-calendar-footer-1-3-2__group__button kuc-base-datetime-calendar-footer-1-3-2__group__button--today"
          @click="${this._handleClickCalendarFooterButtonToday}"
        >
          ${this._locale.CALENDAR_FOOTER_TEXT.today}
        </button>
        <span class="kuc-base-datetime-calendar-footer-1-3-2__group__center"></span>
        <button
          type="button"
          tabindex="0"
          class="kuc-base-datetime-calendar-footer-1-3-2__group__button kuc-base-datetime-calendar-footer-1-3-2__group__button--none"
...
if (!window.customElements.get("kuc-base-datetime-calendar-footer-1-3-2")) {
    createStyleOnHeader(CALENDAR_FOOTER_CSS);
    window.customElements.define("kuc-base-datetime-calendar-footer-1-3-2", BaseDateTimeCalendarFooter);
}
