...
if (!window.customElements.get("kuc-base-datetime-calendar-footer-1-4-0")) {
    createStyleOnHeader(CALENDAR_FOOTER_CSS);
    window.customElements.define("kuc-base-datetime-calendar-footer-1-4-0", BaseDateTimeCalendarFooter);
}
