...
export class BaseDateTimeHeaderMonth extends KucBase {
    ...
    render() {
        return html `
      <button
        class="kuc-base-datetime-header-month-1-3-2__toggle"
      ...
      >
        <span class="kuc-base-datetime-header-month-1-3-2__toggle__label"
          >${this._monthLabel}</span
        >
        <span class="kuc-base-datetime-header-month-1-3-2__toggle__icon"
    ...
    updated(changedProperties) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            _super.update.call(this, changedProperties);
        });
    }
    ...
    _getListBoxTemplate() {
        return this._listBoxVisible
          ...
          <kuc-base-datetime-listbox-1-3-2
            ...
            class="kuc-base-datetime-header-month-1-3-2__listbox"
...
__decorate([
    query(".kuc-base-datetime-header-month-1-3-2__toggle")
], BaseDateTimeHeaderMonth.prototype, "_toggleEl", void 0);
if (!window.customElements.get("kuc-base-datetime-header-month-1-3-2")) {
    createStyleOnHeader(CALENDAR_HEADER_MONTH_CSS);
    window.customElements.define("kuc-base-datetime-header-month-1-3-2", BaseDateTimeHeaderMonth);
}
