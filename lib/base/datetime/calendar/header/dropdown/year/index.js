...
__decorate([
    query(".kuc-base-datetime-header-year-1-4-0__toggle")
], BaseDateTimeHeaderYear.prototype, "_toggleEl", void 0);
if (!window.customElements.get("kuc-base-datetime-header-year-1-4-0")) {
    createStyleOnHeader(CALENDAR_HEADER_YEAR_CSS);
    window.customElements.define("kuc-base-datetime-header-year-1-4-0", BaseDateTimeHeaderYear);
}
