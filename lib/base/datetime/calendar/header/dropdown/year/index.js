...
export class BaseDateTimeHeaderYear extends KucBase {
    ...
    render() {
        return html `
      <button
        class="kuc-base-datetime-header-year-1-3-2__toggle"
      ...
      >
        <span class="kuc-base-datetime-header-year-1-3-2__toggle__label"
          >${this.year}${this.postfix}</span
        >
        <span class="kuc-base-datetime-header-year-1-3-2__toggle__icon"
    ...
    _getListBoxTemplate() {
        return this._listBoxVisible
          ...
          <kuc-base-datetime-listbox-1-3-2
            ...
            class="kuc-base-datetime-header-year-1-3-2__listbox"
...
__decorate([
    query(".kuc-base-datetime-header-year-1-3-2__toggle")
], BaseDateTimeHeaderYear.prototype, "_toggleEl", void 0);
if (!window.customElements.get("kuc-base-datetime-header-year-1-3-2")) {
    createStyleOnHeader(CALENDAR_HEADER_YEAR_CSS);
    window.customElements.define("kuc-base-datetime-header-year-1-3-2", BaseDateTimeHeaderYear);
}
