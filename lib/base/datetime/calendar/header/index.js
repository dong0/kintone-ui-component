...
export class BaseDateTimeCalendarHeader extends KucBase {
    ...
    render() {
        return html `
      <div class="kuc-base-datetime-calendar-header-1-3-2__group">
        <button
          aria-label="previous month"
          type="button"
          class="kuc-base-datetime-calendar-header-1-3-2__group__button kuc-base-datetime-calendar-header-1-3-2__group__button--previous-month"
          @click="${this._handleClickCalendarPrevMonthBtn}"
          @keydown="${this._handleKeyDownCalendarPrevMonthBtn}"
        >
          ${getLeftArrowIconSvgTemplate()}
        </button>
        <div class="kuc-base-datetime-calendar-header-1-3-2__group__center">
          ${this._getYearMonthTemplate()}
        </div>
        <button
          aria-label="next month"
          type="button"
          class="kuc-base-datetime-calendar-header-1-3-2__group__button kuc-base-datetime-calendar-header-1-3-2__group__button--next-month"
    ...
    _getYearTemplate() {
        return html `
      <kuc-base-datetime-header-year-1-3-2
        class="kuc-base-datetime-calendar-header-1-3-2__year"
    ...
    _getMonthTemplate() {
        return html `
      <kuc-base-datetime-header-month-1-3-2
        class="kuc-base-datetime-calendar-header-1-3-2__month"
        .month="${this.month}"
...
__decorate([
    query(".kuc-base-datetime-calendar-header-1-3-2__month")
], BaseDateTimeCalendarHeader.prototype, "_baseDateTimeHeaderMonthEl", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-header-1-3-2__year")
], BaseDateTimeCalendarHeader.prototype, "_baseDateTimeHeaderYearEl", void 0);
__decorate([
    query(".kuc-base-datetime-header-month-1-3-2__listbox")
], BaseDateTimeCalendarHeader.prototype, "_listBoxMonthEl", void 0);
__decorate([
    query(".kuc-base-datetime-header-year-1-3-2__listbox")
], BaseDateTimeCalendarHeader.prototype, "_listBoxYearEl", void 0);
if (!window.customElements.get("kuc-base-datetime-calendar-header-1-3-2")) {
    createStyleOnHeader(CALENDAR_HEADER_CSS);
    window.customElements.define("kuc-base-datetime-calendar-header-1-3-2", BaseDateTimeCalendarHeader);
}
