...
__decorate([
    query(".kuc-base-datetime-calendar-1-4-0__group")
], BaseDateTimeCalendar.prototype, "_baseCalendarGroupEl", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-header-1-4-0__month")
], BaseDateTimeCalendar.prototype, "_monthEl", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-header-1-4-0__year")
], BaseDateTimeCalendar.prototype, "_yearEl", void 0);
__decorate([
    query(".kuc-base-datetime-header-month-1-4-0__listbox")
], BaseDateTimeCalendar.prototype, "_listBoxMonthEl", void 0);
__decorate([
    query(".kuc-base-datetime-header-year-1-4-0__listbox")
...
if (!window.customElements.get("kuc-base-datetime-calendar-1-4-0")) {
    createStyleOnHeader(CALENDAR_CSS);
    window.customElements.define("kuc-base-datetime-calendar-1-4-0", BaseDateTimeCalendar);
}
