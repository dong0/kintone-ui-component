...
export class BaseDateTimeCalendar extends KucBase {
    ...
    render() {
        return html `
      <div
        class="kuc-base-datetime-calendar-1-3-2__group"
        role="dialog"
        aria-modal="true"
        aria-label="Calender"
      ...
      >
        <kuc-base-datetime-calendar-header-1-3-2
          .year="${this._year}"
          .month="${this._month}"
        ...
        ></kuc-base-datetime-calendar-body-1-3-2>
        <kuc-base-datetime-calendar-footer-1-3-2
          .language="${this.language}"
        ></kuc-base-datetime-calendar-footer-1-3-2>
      </div>
    `;
...
__decorate([
    query(".kuc-base-datetime-calendar-1-3-2__group")
...
if (!window.customElements.get("kuc-base-datetime-calendar-1-3-2")) {
    createStyleOnHeader(CALENDAR_CSS);
    window.customElements.define("kuc-base-datetime-calendar-1-3-2", BaseDateTimeCalendar);
}
