...
export class BaseMobileError extends KucBase {
    ...
    render() {
      ...
      ${this.ariaLive && this.ariaLive !== ""
            ? html `
            <div
              class="kuc-base-mobile-error-1-3-2__error"
              .id="${this.guid}-error"
              role="alert"
...
if (!window.customElements.get("kuc-base-mobile-error-1-3-2")) {
    createStyleOnHeader(BASE_MOBILE_ERROR_CSS);
    window.customElements.define("kuc-base-mobile-error-1-3-2", BaseMobileError);
}
