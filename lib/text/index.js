...
let exportText;
(() => {
    exportText = window.customElements.get("kuc-text-1-3-2");
    if (exportText) {
        return;
    }
    class KucText extends KucBase {
        ...
        render() {
            return html `
        <div class="kuc-text-1-3-2__group">
          <label
            class="kuc-text-1-3-2__group__label"
          ...
          <div class="kuc-text-1-3-2__group__input-form">
            <div class="kuc-text-1-3-2__group__input-form__prefix-outer">
              <span
                class="kuc-text-1-3-2__group__input-form__prefix-outer__prefix"
                ?hidden="${!this.prefix}"
                >${this.prefix}</span
              >
            </div>
            <div class="kuc-text-1-3-2__group__input-form__input-outer">
              <input
                class="kuc-text-1-3-2__group__input-form__input-outer__input"
                id="${this._GUID}-label"
            ...
            <div class="kuc-text-1-3-2__group__input-form__suffix-outer">
              <span
                class="kuc-text-1-3-2__group__input-form__suffix-outer__suffix"
                ?hidden="${!this.suffix}"
                >${this.suffix}</span
              >
            </div>
    ...
    window.customElements.define("kuc-text-1-3-2", KucText);
