...
let exportTextarea;
(() => {
    exportTextarea = window.customElements.get("kuc-textarea-1-3-2");
    if (exportTextarea) {
        return;
    }
    ...
    class KucTextArea extends KucBase {
      ...
      `;
        ...
        render() {
            return html `
        <div class="kuc-textarea-1-3-2__group">
          <label
            class="kuc-textarea-1-3-2__group__label"
            ?hidden="${!this.label}"
          ...
          <textarea
            id="${this._GUID}-label"
            class="kuc-textarea-1-3-2__group__textarea"
          ...
          <div
            class="kuc-textarea-1-3-2__group__resizer"
    ...
    __decorate([
        query(".kuc-textarea-1-3-2__group__textarea")
    ], KucTextArea.prototype, "_textarea", void 0);
    window.customElements.define("kuc-textarea-1-3-2", KucTextArea);
