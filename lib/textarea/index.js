...
let exportTextarea;
(() => {
    exportTextarea = window.customElements.get("kuc-textarea-1-4-0");
    if (exportTextarea) {
        return;
    }
    ...
    __decorate([
        query(".kuc-textarea-1-4-0__group__textarea")
    ], KucTextArea.prototype, "_textarea", void 0);
    window.customElements.define("kuc-textarea-1-4-0", KucTextArea);
