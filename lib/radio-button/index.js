...
(() => {
    exportRadioButton = window.customElements.get("kuc-radio-button-1-3-2");
    ...
    class KucRadioButton extends KucBase {
        ...
        _getRadioIconSvgTemplate(disabled, checked) {
            return svg `
    <svg
      class="kuc-radio-button-1-3-2__group__select-menu__item__label__icon"
      width="21"
      height="21"
      viewBox="0 0 21 21"
      fill="none"
  ...
  `;
        ...
        _getItemTemplate(item, index) {
            ...
            return html `
        <div
          class="kuc-radio-button-1-3-2__group__select-menu__item"
        ...
        >
          <input
            ...
            class="kuc-radio-button-1-3-2__group__select-menu__item__input"
          ...
          />
          <label
            class="kuc-radio-button-1-3-2__group__select-menu__item__label"
      ...
      `;
        ...
        render() {
            return html `
        <div
          class="kuc-radio-button-1-3-2__group"
          role="radiogroup"
          aria-labelledby="${this._GUID}-group"
        >
          <div class="kuc-radio-button-1-3-2__group__label" ?hidden="${!this.label}">
          ...
          <div
            class="kuc-radio-button-1-3-2__group__select-menu"
