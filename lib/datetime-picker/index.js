...
import { FORMAT_IS_NOT_VALID, MAX_MIN_IS_NOT_VALID, TIME_IS_OUT_OF_VALID_RANGE, TIMESTEP_IS_NOT_NUMBER, MIN_TIME, MAX_TIME, } from "../base/datetime/resource/constant";
...
(() => {
    exportDateTimePicker = window.customElements.get("kuc-datetime-picker-1-3-2");
    ...
    class KucDateTimePicker extends KucBase {
        ...
        render() {
            return html `
        <fieldset
          class="kuc-datetime-picker-1-3-2__group"
          aria-describedby="${this._GUID}-error"
        >
          <legend
            class="kuc-datetime-picker-1-3-2__group__label"
            ?hidden="${!this.label}"
          >
          ...
          <div class="kuc-datetime-picker-1-3-2__group__inputs">
            <kuc-base-date-1-3-2
              class="kuc-datetime-picker-1-3-2__group__inputs--date"
            ...
            ></kuc-base-date-1-3-2
            ><kuc-base-time-1-3-2
              class="kuc-datetime-picker-1-3-2__group__inputs--time"
    ...
    __decorate([
        query("kuc-base-label-1-3-2")
    ], KucDateTimePicker.prototype, "_baseLabelEl", void 0);
    __decorate([
        query("kuc-base-error-1-3-2")
    ], KucDateTimePicker.prototype, "_baseErrorEl", void 0);
    window.customElements.define("kuc-datetime-picker-1-3-2", KucDateTimePicker);
