...
(() => {
    exportDateTimePicker = window.customElements.get("kuc-datetime-picker-1-4-0");
    ...
    __decorate([
        query("kuc-base-label-1-4-0")
    ], KucDateTimePicker.prototype, "_baseLabelEl", void 0);
    __decorate([
        query("kuc-base-error-1-4-0")
    ], KucDateTimePicker.prototype, "_baseErrorEl", void 0);
    window.customElements.define("kuc-datetime-picker-1-4-0", KucDateTimePicker);
