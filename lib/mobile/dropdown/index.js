...
(() => {
    exportMobileDropdown = window.customElements.get("kuc-mobile-dropdown-1-3-2");
    ...
    class KucMobileDropdown extends KucBase {
      ...
      `;
        ...
        render() {
            return html `
        <label
          class="kuc-mobile-dropdown-1-3-2__label"
        ...
        <div class="kuc-mobile-dropdown-1-3-2__input-form">
          <div
            class="kuc-mobile-dropdown-1-3-2__input-form__select
            ${this.requiredIcon ? "kuc--required" : ""}"
          >
            <select
              class="kuc-mobile-dropdown-1-3-2__input-form__select__input"
              id="${this._GUID}-label"
    ...
    __decorate([
        query(".kuc-mobile-dropdown-1-3-2__input-form__select__input")
    ], KucMobileDropdown.prototype, "_selectEl", void 0);
    window.customElements.define("kuc-mobile-dropdown-1-3-2", KucMobileDropdown);
