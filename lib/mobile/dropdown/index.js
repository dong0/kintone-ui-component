...
(() => {
    exportMobileDropdown = window.customElements.get("kuc-mobile-dropdown-1-4-0");
    ...
    __decorate([
        query(".kuc-mobile-dropdown-1-4-0__input-form__select__input")
    ], KucMobileDropdown.prototype, "_selectEl", void 0);
    window.customElements.define("kuc-mobile-dropdown-1-4-0", KucMobileDropdown);
