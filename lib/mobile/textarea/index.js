...
(() => {
    exportMobileTextArea = window.customElements.get("kuc-mobile-textarea-1-3-2");
    ...
    class KucMobileTextArea extends KucBase {
        ...
        render() {
            return html `
        <label
          class="kuc-mobile-textarea-1-3-2__label"
        ...
        <div class="kuc-mobile-textarea-1-3-2__form">
          <textarea
            class="kuc-mobile-textarea-1-3-2__form__textarea"
            id="${this._GUID}-label"
    ...
    window.customElements.define("kuc-mobile-textarea-1-3-2", KucMobileTextArea);
