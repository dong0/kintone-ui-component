...
(() => {
    exportMobileMultiChoice = window.customElements.get("kuc-mobile-multi-choice-1-3-2");
    ...
    class KucMobileMultiChoice extends KucBase {
      ...
      `;
        ...
        render() {
            return html `
        <label
          class="kuc-mobile-multi-choice-1-3-2__label"
        ...
        <div class="kuc-mobile-multi-choice-1-3-2__input-form">
          <div
            class="kuc-mobile-multi-choice-1-3-2__input-form__select
            ${this.requiredIcon ? "kuc--required" : ""}"
          >
            <select
              class="kuc-mobile-multi-choice-1-3-2__input-form__select__input"
              id="${this._GUID}-label"
    ...
    window.customElements.define("kuc-mobile-multi-choice-1-3-2", KucMobileMultiChoice);
