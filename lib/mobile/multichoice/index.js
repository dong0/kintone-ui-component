...
(() => {
    exportMobileMultiChoice = window.customElements.get("kuc-mobile-multi-choice-1-4-0");
    ...
    window.customElements.define("kuc-mobile-multi-choice-1-4-0", KucMobileMultiChoice);
