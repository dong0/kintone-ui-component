...
(() => {
    exportMobileDatePicker = window.customElements.get("kuc-mobile-date-picker-1-4-0");
    ...
    window.customElements.define("kuc-mobile-date-picker-1-4-0", KucMobileDatePicker);
