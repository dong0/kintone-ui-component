...
(() => {
    exportMobileDateTimePicker = window.customElements.get("kuc-mobile-datetime-picker-1-3-2");
    ...
    class KucMobileDateTimePicker extends KucBase {
        ...
        render() {
            return html `
        <fieldset
          class="kuc-mobile-datetime-picker-1-3-2__group"
          aria-describedby="${this._GUID}-error"
        >
          <legend
            class="kuc-mobile-datetime-picker-1-3-2__group__label"
            ?hidden="${!this.label}"
          >
          ...
          <div class="kuc-mobile-datetime-picker-1-3-2__group__input">
            <kuc-mobile-base-date-1-3-2
              class="kuc-mobile-datetime-picker-1-3-2__group__input--date"
            ...
            <kuc-base-mobile-time-1-3-2
              class="kuc-mobile-datetime-picker-1-3-2__group__input--time"
    ...
    window.customElements.define("kuc-mobile-datetime-picker-1-3-2", KucMobileDateTimePicker);
