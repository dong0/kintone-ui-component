...
(() => {
    exportMobileDateTimePicker = window.customElements.get("kuc-mobile-datetime-picker-1-4-0");
    ...
    window.customElements.define("kuc-mobile-datetime-picker-1-4-0", KucMobileDateTimePicker);
