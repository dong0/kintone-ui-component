...
(() => {
    exportMobileText = window.customElements.get("kuc-mobile-text-1-3-2");
    if (exportMobileText) {
        return;
    }
    class KucMobileText extends KucBase {
        ...
        render() {
            return html `
        <label
          class="kuc-mobile-text-1-3-2__label"
        ...
        <div class="kuc-mobile-text-1-3-2__input-form">
          <span
            class="kuc-mobile-text-1-3-2__input-form__prefix"
            ?hidden="${!this.prefix}"
            >${this.prefix}</span
          >
          <input
            class="kuc-mobile-text-1-3-2__input-form__input"
            id="${this._GUID}-label"
          ...
          />
          <span
            class="kuc-mobile-text-1-3-2__input-form__suffix"
            ?hidden="${!this.suffix}"
            >${this.suffix}</span
          >
        </div>
    ...
    window.customElements.define("kuc-mobile-text-1-3-2", KucMobileText);
