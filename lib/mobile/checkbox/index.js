...
(() => {
    exportMobileCheckbox = window.customElements.get("kuc-mobile-checkbox-1-3-2");
    ...
    class KucMobileCheckbox extends KucBase {
        ...
        _getCheckboxIconSvgTemplate(checked) {
            return svg `
       <svg
         class="kuc-mobile-checkbox-1-3-2__group__select-menu__item__label__icon"
       ...
       `;
        ...
        <label
          ...
          class="kuc-mobile-checkbox-1-3-2__group__select-menu__item"
          ?borderVisible="${this.borderVisible}"
        >
          <input
            type="checkbox"
            id="${this._GUID}-item-${index}"
            class="kuc-mobile-checkbox-1-3-2__group__select-menu__item__input"
          ...
          />
          <div class="kuc-mobile-checkbox-1-3-2__group__select-menu__item__label">
      ...
      `;
        ...
        render() {
            return html `
        <fieldset class="kuc-mobile-checkbox-1-3-2__group">
          <legend
            class="kuc-mobile-checkbox-1-3-2__group__label"
            ?hidden="${!this.label}"
          >
          ...
          <div
            class="kuc-mobile-checkbox-1-3-2__group__select-menu ${this.requiredIcon
                ? "kuc-mobile-checkbox-1-3-2__group__select-menu--required"
                : ""}"
            ?borderVisible="${this.borderVisible}"
            ?disabled="${this.disabled}"
          >
    ...
    __decorate([
        queryAll(".kuc-mobile-checkbox-1-3-2__group__select-menu__item__input")
    ], KucMobileCheckbox.prototype, "_inputEls", void 0);
    __decorate([
        state()
    ], KucMobileCheckbox.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-mobile-checkbox-1-3-2", KucMobileCheckbox);
