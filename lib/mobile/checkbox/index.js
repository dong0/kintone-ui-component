...
], MobileCheckbox.prototype, "className", void 0);
__decorate([
    property({ type: String })
], MobileCheckbox.prototype, "error", void 0);
__decorate([
    property({ type: String, reflect: true, attribute: "id" })
], MobileCheckbox.prototype, "id", void 0);
__decorate([
    property({ type: String })
...
__decorate([
    property({ type: Array })
], MobileCheckbox.prototype, "selectedIndex", void 0);
__decorate([
    property({ type: Array })
...
__decorate([
    state()
], MobileCheckbox.prototype, "_valueMapping", void 0);
