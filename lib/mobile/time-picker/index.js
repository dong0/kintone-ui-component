...
(() => {
    exportMobileTimePicker = window.customElements.get("kuc-mobile-time-picker-1-3-2");
    ...
    class KucMobileTimePicker extends KucBase {
        ...
        render() {
            return html `
        <div class="kuc-mobile-time-picker-1-3-2__group">
          <label
            class="kuc-mobile-time-picker-1-3-2__group__label"
            ?hidden="${!this.label}"
          >
          ...
          <div class="kuc-base-mobile-time-1-3-2__group__wrapper">
    ...
    window.customElements.define("kuc-mobile-time-picker-1-3-2", KucMobileTimePicker);
