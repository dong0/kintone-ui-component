...
(() => {
    exportMobileTimePicker = window.customElements.get("kuc-mobile-time-picker-1-4-0");
    ...
    window.customElements.define("kuc-mobile-time-picker-1-4-0", KucMobileTimePicker);
