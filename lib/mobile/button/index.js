...
(() => {
    exportMobileButton = window.customElements.get("kuc-mobile-button-1-3-2");
    ...
    class KucMobileButton extends KucBase {
        ...
        <button
          type="button"
          class="kuc-mobile-button-1-3-2__button kuc-mobile-button-1-3-2__button--${this._getButtonColorType()}"
    ...
    window.customElements.define("kuc-mobile-button-1-3-2", KucMobileButton);
