...
(() => {
    exportMobileRadioButton = window.customElements.get("kuc-mobile-radio-button-1-3-2");
    ...
    class KucMobileRadioButton extends KucBase {
        ...
        _getRadioIconSvgTemplate(disabled, checked) {
            return svg `
      <svg
        class="kuc-mobile-radio-button-1-3-2__group__select-menu__item__label__icon"
        width="21"
        height="21"
        viewBox="0 0 21 21"
        fill="none"
    ...
    `;
        ...
        _getItemTemplate(item, index) {
            ...
            return html `
        <div class="kuc-mobile-radio-button-1-3-2__group__select-menu__item">
          <input
            type="radio"
            aria-describedby="${this._GUID}-error"
            id="${this._GUID}-item-${index}"
            data-index="${index}"
            class="kuc-mobile-radio-button-1-3-2__group__select-menu__item__input"
          ...
          />
          <label
            class="kuc-mobile-radio-button-1-3-2__group__select-menu__item__label"
            for="${this._GUID}-item-${index}"
            >${this._getRadioIconSvgTemplate(this.disabled, isCheckedItem)}
            <div
              class="kuc-mobile-radio-button-1-3-2__group__select-menu__item__label__value"
            >
      ...
      `;
        ...
        render() {
            return html `
        <div class="kuc-mobile-radio-button-1-3-2__group">
          <div
            class="kuc-mobile-radio-button-1-3-2__group__label"
            ?hidden="${!this.label}"
          >
          ...
          <div
            class="kuc-mobile-radio-button-1-3-2__group__select-menu"
    ...
    __decorate([
        queryAll(".kuc-mobile-radio-button-1-3-2__group__select-menu__item__input")
    ], KucMobileRadioButton.prototype, "_inputEls", void 0);
    window.customElements.define("kuc-mobile-radio-button-1-3-2", KucMobileRadioButton);
