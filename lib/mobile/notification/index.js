...
(() => {
    exportMobileNotification = window.customElements.get("kuc-mobile-notification-1-4-0");
    ...
    class KucMobileNotification extends KucBase {
      ...
      `;
        ...
        open() {
            ...
            this.performUpdate();
            this.classList.remove("kuc-mobile-notification-fadeout-1-4-0");
            this.classList.add("kuc-mobile-notification-fadein-1-4-0");
            this._isOpened = true;
            this._setAutoCloseTimer();
        }
        close() {
            this._isOpened = false;
            this.classList.remove("kuc-mobile-notification-fadein-1-4-0");
            this.classList.add("kuc-mobile-notification-fadeout-1-4-0");
            this._clearAutoCloseTimer();
    ...
    window.customElements.define("kuc-mobile-notification-1-4-0", KucMobileNotification);
