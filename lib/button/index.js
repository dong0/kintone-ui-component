...
let exportButton;
(() => {
    exportButton = window.customElements.get("kuc-button-1-3-2");
    if (exportButton) {
        return;
    }
    class KucButton extends KucBase {
        ...
        <button
          type="button"
          class="kuc-button-1-3-2__button kuc-button-1-3-2__button--${this._getButtonColorType()}"
    ...
    window.customElements.define("kuc-button-1-3-2", KucButton);
