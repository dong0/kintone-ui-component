...
(() => {
    exportNotification = window.customElements.get("kuc-notification-1-4-0");
    ...
    class KucNotification extends KucBase {
      ...
      `;
        ...
        open() {
            ...
            this.performUpdate();
            this.classList.remove("kuc-notification-fadeout-1-4-0");
            this.classList.add("kuc-notification-fadein-1-4-0");
            this._isOpened = true;
            this._setAutoCloseTimer();
        }
        close() {
            this._isOpened = false;
            this.classList.remove("kuc-notification-fadein-1-4-0");
            this.classList.add("kuc-notification-fadeout-1-4-0");
            this._clearAutoCloseTimer();
        ...
        render() {
            return html `
        <div
          class="kuc-notification-1-4-0__notification kuc-notification-1-4-0__notification--${this
                .type}"
        >
          <pre
    ...
    window.customElements.define("kuc-notification-1-4-0", KucNotification);
