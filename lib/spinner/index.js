...
let exportSpinner;
(() => {
    exportSpinner = window.customElements.get("kuc-spinner-1-4-0");
    if (exportSpinner) {
        return;
    }
    class KucSpinner extends KucBase {
      ...
      `;
        ...
        <div class="kuc-spinner-1-4-0__spinner" aria-live="assertive" role="alert">
          ...
          <div
            class="kuc-spinner-1-4-0__spinner__text${!this.text
                ? " visually-hidden"
                : ""}"
          >
    ...
    window.customElements.define("kuc-spinner-1-4-0", KucSpinner);
