...
let exportSpinner;
(() => {
    exportSpinner = window.customElements.get("kuc-spinner-1-3-2");
    if (exportSpinner) {
        return;
    }
    class KucSpinner extends KucBase {
        ...
        _getSpinnerSvgTemplate() {
            return svg `
        <svg
          class="kuc-spinner-1-3-2__spinner__loader"
          viewBox="0 0 50 50"
          aria-hidden="true"
        >
      ...
      `;
        ...
        render() {
            return html `
        <div class="kuc-spinner-1-3-2__spinner" aria-live="assertive" role="alert">
          ${this._getSpinnerSvgTemplate()}
          <div
            class="kuc-spinner-1-3-2__spinner__text${!this.text
                ? " visually-hidden"
                : ""}"
          >
        ...
        <div class="kuc-spinner-1-3-2__mask"></div>
      `;
        }
    }
    __decorate([
    ...
    window.customElements.define("kuc-spinner-1-3-2", KucSpinner);
