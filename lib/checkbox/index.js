...
let exportCheckbox;
(() => {
    exportCheckbox = window.customElements.get("kuc-checkbox-1-4-0");
    if (exportCheckbox) {
        return;
    }
  ...
  `;
    ...
    __decorate([
        queryAll(".kuc-checkbox-1-4-0__group__select-menu__item__input")
    ], KucCheckbox.prototype, "_inputEls", void 0);
    __decorate([
        state()
    ], KucCheckbox.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-checkbox-1-4-0", KucCheckbox);
