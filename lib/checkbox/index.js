...
let exportCheckbox;
(() => {
    exportCheckbox = window.customElements.get("kuc-checkbox-1-3-2");
    if (exportCheckbox) {
        return;
    }
    class KucCheckbox extends KucBase {
        ...
        _getCheckboxIconSvgTemplate(disabled, checked) {
            return svg `
    <svg
      class="kuc-checkbox-1-3-2__group__select-menu__item__label__icon"
      width="21"
      height="21"
      viewBox="0 0 21 21"
      fill="none"
  ...
  `;
        ...
        _getItemTemplate(item, index) {
            ...
            return html `
        <div
          class="kuc-checkbox-1-3-2__group__select-menu__item"
        ...
        >
          <input
            ...
            class="kuc-checkbox-1-3-2__group__select-menu__item__input"
          ...
          <label
            ...
            class="kuc-checkbox-1-3-2__group__select-menu__item__label"
      ...
      `;
        ...
        render() {
            return html `
        <div
          class="kuc-checkbox-1-3-2__group"
          role="group"
          aria-labelledby="${this._GUID}-group"
        >
          <div class="kuc-checkbox-1-3-2__group__label" ?hidden="${!this.label}">
          ...
          <div
            class="kuc-checkbox-1-3-2__group__select-menu"
    ...
    __decorate([
        queryAll(".kuc-checkbox-1-3-2__group__select-menu__item__input")
    ], KucCheckbox.prototype, "_inputEls", void 0);
    __decorate([
        state()
    ], KucCheckbox.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-checkbox-1-3-2", KucCheckbox);
