...
(() => {
    exportTimePicker = window.customElements.get("kuc-time-picker-1-3-2");
    if (exportTimePicker) {
        return;
    }
    class KucTimePicker extends KucBase {
        ...
        render() {
            return html `
        <fieldset
          class="kuc-time-picker-1-3-2__group"
          aria-describedby="${this._GUID}-error"
        >
          <legend
            class="kuc-time-picker-1-3-2__group__label"
            ?hidden="${!this.label}"
          >
          ...
          <kuc-base-time-1-3-2
            class="kuc-time-picker-1-3-2__group__input"
    ...
    window.customElements.define("kuc-time-picker-1-3-2", KucTimePicker);
