...
(() => {
    exportMultiChoice = window.customElements.get("kuc-multi-choice-1-4-0");
      ...
      `;
        ...
        _handleMouseOverMultiChoiceItem(event) {
            ...
            this._itemsEl.forEach((itemEl) => {
                if (itemEl.classList.contains("kuc-multi-choice-1-4-0__group__menu__highlight")) {
                    itemEl.classList.remove("kuc-multi-choice-1-4-0__group__menu__highlight");
                }
            });
            const itemEl = event.currentTarget;
            itemEl.classList.add("kuc-multi-choice-1-4-0__group__menu__highlight");
        ...
        _handleKeyDownMultiChoice(event) {
            ...
            switch (event.key) {
                ...
                case "ArrowUp": {
                    ...
                    currentItemEl.classList.add("kuc-multi-choice-1-4-0__group__menu__highlight");
    ...
    __decorate([
        query(".kuc-multi-choice-1-4-0__group__menu")
    ], KucMultiChoice.prototype, "_menuEl", void 0);
    __decorate([
        queryAll(".kuc-multi-choice-1-4-0__group__menu__item")
    ], KucMultiChoice.prototype, "_itemsEl", void 0);
    __decorate([
        state()
    ], KucMultiChoice.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-multi-choice-1-4-0", KucMultiChoice);
