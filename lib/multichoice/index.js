...
(() => {
    exportMultiChoice = window.customElements.get("kuc-multi-choice-1-3-2");
    ...
    class KucMultiChoice extends KucBase {
        ...
        render() {
            return html `
        <div class="kuc-multi-choice-1-3-2__group">
          <div
            class="kuc-multi-choice-1-3-2__group__label"
            id="${this._GUID}-label"
            ?hidden="${!this.label}"
          >
          ...
          <div
            class="kuc-multi-choice-1-3-2__group__menu"
            role="listbox"
      ...
      `;
        ...
        _handleMouseOverMultiChoiceItem(event) {
            ...
            this._itemsEl.forEach((itemEl) => {
                if (itemEl.classList.contains("kuc-multi-choice-1-3-2__group__menu__highlight")) {
                    itemEl.classList.remove("kuc-multi-choice-1-3-2__group__menu__highlight");
                }
            });
            const itemEl = event.currentTarget;
            itemEl.classList.add("kuc-multi-choice-1-3-2__group__menu__highlight");
        ...
        _handleKeyDownMultiChoice(event) {
            ...
            switch (event.key) {
                ...
                case "ArrowUp": {
                    ...
                    currentItemEl.classList.add("kuc-multi-choice-1-3-2__group__menu__highlight");
        ...
        ${checked
                ? svg `<svg
            class="kuc-multi-choice-1-3-2__group__menu__item__icon"
            width="11"
            height="9"
            viewBox="0 0 11 9"
            fill="none"
        ...
        _getMenuItemTemplate(item, index) {
            ...
            return html `
        <div
          class="kuc-multi-choice-1-3-2__group__menu__item"
          role="option"
    ...
    __decorate([
        query(".kuc-multi-choice-1-3-2__group__menu")
    ], KucMultiChoice.prototype, "_menuEl", void 0);
    __decorate([
        queryAll(".kuc-multi-choice-1-3-2__group__menu__item")
    ], KucMultiChoice.prototype, "_itemsEl", void 0);
    __decorate([
        state()
    ], KucMultiChoice.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-multi-choice-1-3-2", KucMultiChoice);
