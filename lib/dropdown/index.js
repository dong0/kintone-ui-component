...
let exportDropdown;
(() => {
    exportDropdown = window.customElements.get("kuc-dropdown-1-4-0");
    if (exportDropdown) {
        return;
    }
      ...
      `;
        ...
        _actionHighlightPrevMenuItem() {
            ...
            if (this._highlightItemEl !== null) {
                ...
                this._highlightItemEl.classList.remove("kuc-dropdown-1-4-0__group__select-menu__highlight");
            }
            if (prevItem === null) {
        ...
        _actionClearAllHighlightMenuItem() {
            this._itemsEl.forEach((itemEl) => {
                itemEl.classList.remove("kuc-dropdown-1-4-0__group__select-menu__highlight");
            });
            this._actionRemoveActiveDescendant();
        }
        ...
        _actionHighlightMenuItem(item) {
            this._actionClearAllHighlightMenuItem();
            item.classList.add("kuc-dropdown-1-4-0__group__select-menu__highlight");
        }
    ...
    __decorate([
        query(".kuc-dropdown-1-4-0__group")
    ], KucDropdown.prototype, "_groupEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-4-0__group__select-menu")
    ], KucDropdown.prototype, "_menuEl", void 0);
    __decorate([
        queryAll(".kuc-dropdown-1-4-0__group__select-menu__item")
    ], KucDropdown.prototype, "_itemsEl", void 0);
    __decorate([
        query("button.kuc-dropdown-1-4-0__group__toggle")
    ], KucDropdown.prototype, "_buttonEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-4-0__group__label")
    ], KucDropdown.prototype, "_labelEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-4-0__group__select-menu__item")
    ], KucDropdown.prototype, "_firstItemEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-4-0__group__select-menu__item:last-child")
    ], KucDropdown.prototype, "_lastItemEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-4-0__group__select-menu__item[aria-selected=true]")
    ], KucDropdown.prototype, "_selectedItemEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-4-0__group__select-menu__highlight")
    ], KucDropdown.prototype, "_highlightItemEl", void 0);
    __decorate([
        query(".kuc-base-error-1-4-0__error")
    ], KucDropdown.prototype, "_errorEl", void 0);
    window.customElements.define("kuc-dropdown-1-4-0", KucDropdown);
