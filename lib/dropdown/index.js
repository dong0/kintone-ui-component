...
let exportDropdown;
(() => {
    exportDropdown = window.customElements.get("kuc-dropdown-1-3-2");
    if (exportDropdown) {
        return;
    }
    ...
    `;
        ...
        render() {
            return html `
        <div class="kuc-dropdown-1-3-2__group">
          <div
            class="kuc-dropdown-1-3-2__group__label"
            id="${this._GUID}-label"
            ?hidden="${!this.label}"
          >
          ...
          <button
            class="kuc-dropdown-1-3-2__group__toggle"
          ...
          >
            <span class="kuc-dropdown-1-3-2__group__toggle__selected-item-label"
              >${this._getSelectedLabel()}</span
            >
            <span class="kuc-dropdown-1-3-2__group__toggle__icon">
              ${this._getToggleIconSvgTemplate()}
            </span>
          </button>
          <ul
            class="kuc-dropdown-1-3-2__group__select-menu"
            role="listbox"
      ...
      `;
        ...
        _actionHighlightPrevMenuItem() {
            ...
            if (this._highlightItemEl !== null) {
                ...
                this._highlightItemEl.classList.remove("kuc-dropdown-1-3-2__group__select-menu__highlight");
            }
            if (prevItem === null) {
        ...
        _actionClearAllHighlightMenuItem() {
            this._itemsEl.forEach((itemEl) => {
                itemEl.classList.remove("kuc-dropdown-1-3-2__group__select-menu__highlight");
            });
            this._actionRemoveActiveDescendant();
        }
        ...
        _actionHighlightMenuItem(item) {
            this._actionClearAllHighlightMenuItem();
            item.classList.add("kuc-dropdown-1-3-2__group__select-menu__highlight");
        }
        ...
        _getItemTemplate(item, index) {
            ...
            return html `
        <li
          class="kuc-dropdown-1-3-2__group__select-menu__item"
          role="option"
      ...
      ${checked
                ? svg `<svg
          class="kuc-dropdown-1-3-2__group__select-menu__item__icon"
          width="11"
          height="9"
          viewBox="0 0 11 9"
          fill="none"
    ...
    __decorate([
        query(".kuc-dropdown-1-3-2__group")
    ], KucDropdown.prototype, "_groupEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-3-2__group__select-menu")
    ], KucDropdown.prototype, "_menuEl", void 0);
    __decorate([
        queryAll(".kuc-dropdown-1-3-2__group__select-menu__item")
    ], KucDropdown.prototype, "_itemsEl", void 0);
    __decorate([
        query("button.kuc-dropdown-1-3-2__group__toggle")
    ], KucDropdown.prototype, "_buttonEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-3-2__group__label")
    ], KucDropdown.prototype, "_labelEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-3-2__group__select-menu__item")
    ], KucDropdown.prototype, "_firstItemEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-3-2__group__select-menu__item:last-child")
    ], KucDropdown.prototype, "_lastItemEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-3-2__group__select-menu__item[aria-selected=true]")
    ], KucDropdown.prototype, "_selectedItemEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-3-2__group__select-menu__highlight")
    ], KucDropdown.prototype, "_highlightItemEl", void 0);
    __decorate([
        query(".kuc-base-error-1-3-2__error")
    ], KucDropdown.prototype, "_errorEl", void 0);
    window.customElements.define("kuc-dropdown-1-3-2", KucDropdown);
